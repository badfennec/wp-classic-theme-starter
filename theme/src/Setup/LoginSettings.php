...
class LoginSettings {
    ...
    public function login_enqueue_scripts() {
        wp_enqueue_style( 'core', THEME_URL . '/assets/css/login.css', null, \Badfennec\Utils\AssetManager::get_file_timestamp( '/assets/css/login.css' ) );
		wp_enqueue_script( 'theme-login-js', THEME_URL . '/assets/js/login.js', null, \Badfennec\Utils\AssetManager::get_file_timestamp( '/assets/js/login.js' ), true);
    }
